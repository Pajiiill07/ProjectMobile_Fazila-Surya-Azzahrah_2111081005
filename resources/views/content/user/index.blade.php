                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                  ...
                  <tbody>
                    ...
                    <tr class="odd">
                      ...
                      <td>
                        <span class="<?php echo getLabelClass($item->hak_akses); ?> me-1">
                          {{$item->hak_akses}}
                        </span>
                      </td>
                      <td>
                        <div class="d-inline-block text-nowrap">
                          <button class="btn btn-sm btn-icon edit-record" data-id="{{$item->user_id}}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEditUser">
                            <i class="bx bx-edit"></i> EDIT
                          </button>
                          <form action="user-backend/{{$item->user_id }}" method="post">
                            @method('DELETE')
                            @csrf
                            <button class="btn btn-sm btn-icon delete-record" data-id="{{$item->user_id}}" onclick="return confirm('Yakin akan menghapus data ?')">
